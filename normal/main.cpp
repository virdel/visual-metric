...
int main(int argc,char* argv[])
{
    ...
    while (frame < targetFrame) {
        ...
        if(frame==targetFrame-1){
            string save_name=save_path+"/normal_output1.png";
        ...
        if(frame==targetFrame-1){
            string save_name=save_path+"/normal_output2.png";
        ...
        if(frame==targetFrame-1){
            string save_name=save_path+"/normal_output3.png";
        ...
        if(frame==targetFrame-1){
            string save_name=save_path+"/normal_output4.png";
    ...
    ofstream file(save_path+"/normal_output.txt");
    if (!file) { // 检查是否成功打开文件
